...
Output: hire, conditional_hire, or reject with detailed justification."""
    ...
    def run(self, state: AgentState) -> AgentState:
        """
        Synthesize debate and make final recommendation using LLM.
        ...
        if self.llm:
            ...
            decision, reasoning = self._make_decision_llm(
            ...
            try:
                ...
                if consistency_check['similar_cases'] > 0:
                    ...
                    if consistency_check['is_consistent']:
                        ...
                        reasoning_text += f"⚠️  INCONSISTENCY DETECTED with {consistency_check['similar_cases']} similar past case(s):\n"
    ...
    def _make_decision_llm(self, candidate, job, scores, evaluator_msg, advocate_msg, skeptic_msg):
...
"""
        ...
        decision_text += "   ⚠️  Identifies risks and weaknesses\n"
        decision_text += "   ⚠️  Challenges assumptions about candidate readiness\n"
        decision_text += "   ⚠️  Questions opportunity cost vs other candidates\n"
