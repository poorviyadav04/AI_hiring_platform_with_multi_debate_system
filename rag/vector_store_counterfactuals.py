    def index_counterfactuals(self, counterfactuals: List[Dict]) -> None:
        ...
        Args:
            counterfactuals: List of counterfactual dicts with keys:
                - candidate_id: ID of original candidate
                - candidate_name: Name of original candidate
                - job_title: Job title
                - type: Type of counterfactual (skill, experience, education, salary)
                - change: Description of the change
                - explanation: Full explanation
                - impact: Impact on score
                - overall_impact: Impact on overall score
        """
    ...
    def search_counterfactuals(
        ...
        Args:
            query: Search query (e.g., "how to improve Python skills", "what if more experience")
        ...
        # Search
        scores, indices = self.counterfactual_index.search(query_embedding, min(top_k * 2, self.counterfactual_index.ntotal))
